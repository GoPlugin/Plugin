  ...
  KeeperRegistryExecutableInterface
{
  ...
  uint96 constant private PLI_TOTAL_SUPPLY = 1e27;
  ...
  /**
   * @notice adds PLI funding for an upkeep by tranferring from the sender's
   * PLI balance
  ...
  /**
   * @notice recovers PLI funds improperly transfered to the registry
 ...
 /**
    ...
    )
  {
    ...
    uint256 total = weiForGas.mul(1e9).mul(premium).div(pliEth);
    ...
    )
  {
    ...
    require(upkeep.balance >= params.maxPliPayment, "insufficient funds");
